...
class Efektas:
    ...
    def start(self):
        ...
        self.webcam.set(3, 320) #nustato vaizdo kameros dydį
...
class Efektas3(Efektas):
    def __init__(self):
        self.image = cv2.imread('img/20090715121700!Vdu_logo.png', -1) #paveikslelis padengti veidui
